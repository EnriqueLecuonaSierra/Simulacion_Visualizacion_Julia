...
## En este módulo vamos a enfocarnos en aprender a graficar procesos estocásticos en Julia para el caso continuo.
# 1) Modificaciones a la caminata aleatoria.
# 2) El movimiento Browniano visto como caso límite de la caminata aleatoria.
